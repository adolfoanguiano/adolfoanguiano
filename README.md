# Hola, soy Adolfo Anguiano Vázquez 👋
### Data Scientist | Abogado | Especialista en Análisis de Riesgos

Soy un **Científico de Datos con una sólida formación jurídica**, especializado en la transformación de datos legales y operativos en decisiones estratégicas de negocio. 

Con una trayectoria centrada en la revisión de relaciones contractuales y prevención de controversias, hoy utilizo herramientas como **Python, SQL y Machine Learning** para resolver problemas complejos con precisión.

---

## 🛠️ Tecnologías y Herramientas
* **Lenguajes y Librerías:** Python (Pandas, Scikit-learn, Seaborn, Matplotlib).
* **Bases de Datos:** SQL.
* **Análisis Estadístico:** Metodología de Bootstrapping y Comprobación de Hipótesis.
* **Productividad:** Google Drive y Sheets para gestión colaborativa.
